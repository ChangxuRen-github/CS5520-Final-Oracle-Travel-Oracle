...
// data model of message that conforms to MessageKit
...
// data model of sender that conforms to MessageKit
struct Sender: SenderType {
    var senderId: String
    var displayName: String
}

// data model of media item
...
class ConversationViewController: MessagesViewController {
    ...
    // conversation view controller must be initialized with this and that user, also a conversation between them
    init(with thisUser: User, with thatUser: User, with conversation: Conversation) {
        self.thisUser = thisUser
        self.thatUser = thatUser
        self.conversation = conversation
        self.thisSender = Sender(senderId: thisUser.uid, displayName: thisUser.displayName)
...
// MARK: - Message data source, layout, and display delegate
extension ConversationViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    ...
    // TODO: if we replace the Firebase.Auth.user to User, we can set the avatar to profile image C.Ren
...
// MARK: - Manage action when we tap on message cell
...
// MARK: - Media input management
extension ConversationViewController {
    // MARK: set up the media message input button. Right now, we suport image message

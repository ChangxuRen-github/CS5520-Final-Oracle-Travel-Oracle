...
class OthersProfileView: UIView {
    // image height
    ...
    func setupUIComponents() {
        ...
        memberSinceLabel = UIElementUtil.createAndAddLabel(to: contentWrapper,
                                                           ...
                                                           isBold: false,
                                                           textColor: UIColor.black)
        messageButton = UIElementUtil.createAndAddButton(to: contentWrapper,
                                                        title: "Send message",
                                                        color: .link,
                                                        titleColor: .white)
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            messageButton.topAnchor.constraint(equalTo: memberSinceLabel.bottomAnchor, constant: Constants.VERTICAL_MARGIN_LARGE),
            messageButton.centerXAnchor.constraint(equalTo: contentWrapper.safeAreaLayoutGuide.centerXAnchor),
            messageButton.leadingAnchor.constraint(equalTo: contentWrapper.safeAreaLayoutGuide.leadingAnchor, constant: Constants.HORIZONTAL_MARGIN_REGULAR),
            messageButton.trailingAnchor.constraint(equalTo: contentWrapper.safeAreaLayoutGuide.trailingAnchor, constant: -Constants.HORIZONTAL_MARGIN_REGULAR),
            messageButton.bottomAnchor.constraint(equalTo: contentWrapper.bottomAnchor)
        ])
    }
